...
const group = 'Analytics CLI essentials';
  ...
  [
    {
      ...
      exec: ({ vscode }) => {
        vscode.window.showInformationMessage('Hello World! Analytics');
      },
    },
    {
      title: 'hey Analytics! show platform',
      exec: ({ vscode }) => {
        vscode.window.showInformationMessage(
          `Analytics platform is "${process.platform}"`,
        );
      },
    },
  ] as CommandType[]
